$(function() {
    var top = $('.content').offset().left; //y座標の初期値を取得
    ...
    $(window).scroll(function() {
        ...
        $('.content').css('top', left + value / 2);
        $('.content').css('top', left + value / 4);
        $('.content').css('top', left + value / 6);
        $('.content').css('top', top + value / 8);
        $('.content').css('top', top + value / 10);
        });
});
...
$(function() {
	var top = $('.content').offset().top; //y座標の初期値を取得
